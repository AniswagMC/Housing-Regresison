...
```{r no-corr-popularity, warning=FALSE, echo = FALSE, message=FALSE,fig.width = 12, fig.height = 5}
...
prediction_all_models <- tibble(
  `Random Forest` = rf_all.validation.prediction, 
  `Linear Regression` = best_lm_validation_predictions, 
  #`LASSO` = 
  #`RIDGE`= 
)
````
