...
train_data_clean <- select(train_data, -X, -performer, -song, -spotify_genre, -spotify_track_album, -date)
...
boxplot(mspe_ridge, mspe_lasso, names = c("Ridge", "Lasso"))
...
test_data_clean <- select(test_data, -X, -performer, -song, -spotify_genre, -spotify_track_album, -date)
